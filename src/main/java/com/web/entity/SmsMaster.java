...
public class SmsMaster implements Serializable {
   ...
   public SmsMaster(String mobileNo, String sms, String otp, String status, Date otpDate, String smsResponse, String smsKey, String smsFrom, String templateId, String entityId, Date responseDate, String sendTxnId, String responseTxnId) {
      this.mobileNo = mobileNo;
      this.sms = sms;
      this.otp = otp;
      this.status = status;
